...
from motionformer_slowfast.datasets.multigrid_helper import ShortCycleBatchSampler
...
def shuffle_dataset(loader, cur_epoch):
    ...
    assert isinstance(
        sampler, (RandomSampler, DistributedSampler, RASampler)
    ), "Sampler type '{}' not supported".format(type(sampler))
    # RandomSampler handles shuffling automatically
    if isinstance(sampler, DistributedSampler) or isinstance(sampler, RASampler):
